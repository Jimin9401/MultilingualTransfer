...
class NMTArgument:
    ...
    def get_args(self):
        ...
        parser.add_argument("--initialize_decoder", action="store_true")
        parser.add_argument("--n_layer_of_decoder", type=int,default=3)
    ...
    def set_savename(self):
        ...
        if self.data["initialize_decoder"]:
            self.data["savename"]+=f"_{self.data['n_layer_of_decoder']}"
...
class InitialArgument:
    ...
    def get_args(self):
        ...
        parser.add_argument("--dataset", choices=["ted"],
                            required=True, type=str)
        parser.add_argument("--src", choices=["en"],
                            required=True, default="en", type=str)
    ...
    def set_savename(self):
        ...
        self.data["savename"] = os.path.join(self.data["checkpoint_dir"],
                                             f"scratch-{self.data['src']}-{self.data['trg']}")

        if self.data["mbart"]:
            self.data["savename"] += "-mbart"
        else:
            self.data["savename"] += "-mono"
